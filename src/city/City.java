...
/**
 * This class manage a town. This class groups different type of letters and
 * distributes them the next day
 * 
 * @author addou
 * 
 */
public class City {
	...
	/*
	 * add the letter to the city post box the inhabitants count is debited
	...
	/*
	 * distribute all letters of last day and remove them of the post box
	 */
